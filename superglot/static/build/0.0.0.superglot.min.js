...
},{"./vocab/vocab_list.jsx":149}],2:[function(require,module,exports){
...
var AnnotatedWord = React.createClass({displayName: "AnnotatedWord",
	render: function()  {
		React.createElement("h1", null, "hi")
	}
});

var AnnotatedWordList = React.createClass({displayName: "AnnotatedWordList",
	render: function()  {
		React.createElement("ul", {class: "inline-list annotated-words style-a"}, 
			 this.props.vocab.map( function(v)  {
				React.createElement("li", null, 
					React.createElement(AnnotatedWord, {word: v.word})
				)
			})
		)
	}.bind(this)
...
//# sourceMappingURL=0.0.0.superglot.min.js.map